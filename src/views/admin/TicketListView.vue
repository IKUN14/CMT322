...
const openOptions = [
  ...
  { value: TicketStatus.Accepted, label: 'Accepted', color: '#818cf8' },
  { value: TicketStatus.Assigned, label: 'Assigned', color: '#38bdf8' },
  { value: TicketStatus.Reassigned, label: 'Reassigned', color: '#f59e0b' },
